...
public class AuthenticationServiceShould
{
    ...
    private readonly ISetup<IAuthenticationStorage,Task<SessionDto>> findSessionSetup;
    ...
    {
        setupDecrypt.ReturnsAsync("EE88598F-5896-4885-BE61-9B31171EAB9E");
        findSessionSetup.ReturnsAsync(new SessionDto(It.IsAny<Guid>(), DateTimeOffset.UtcNow.AddDays(-1)));
    ...
    public async Task ReturnIdentity_WhenSessionIsValid()
    {
        ...
        findSessionSetup.ReturnsAsync(new SessionDto(userId, DateTimeOffset.UtcNow.AddDays(1)));
