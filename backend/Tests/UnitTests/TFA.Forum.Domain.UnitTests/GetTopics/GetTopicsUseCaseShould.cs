...
public class GetTopicsUseCaseShould
{
    ...
    public async Task ThrowForumNotFoundException_WhenNoForum()
    {
        ...
        getForumsSetup.ReturnsAsync(new Entities.Forum[] { new() { Id = Guid.Parse("01B1C554-184B-4B32-913E-F7031AAD3BAC") } });
    ...
    public async Task ReturnTopics_ExtractedFromStorage_WhenForumExists()
    {
        ...
        getForumsSetup.ReturnsAsync(new Entities.Forum[] { new() { Id = Guid.Parse("845D0972-0E11-4BD2-A102-299E99590267") } });
