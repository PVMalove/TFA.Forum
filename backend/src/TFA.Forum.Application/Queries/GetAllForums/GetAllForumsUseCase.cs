...
public class GetAllForumsUseCase(IGetAllForumsStorage storage)
    : IQueryHandler<IReadOnlyList<ForumGetDto>, GetAllSortedForumsQuery>
{
    public async Task<Result<IReadOnlyList<ForumGetDto>, ErrorList>> Execute(GetAllSortedForumsQuery query,
